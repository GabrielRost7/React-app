...
function ItemDetail({id, img, modelo, descripcion, valor, Category}){  
    ...
    return(
        <div className="card card-container-detalle">
            ...
            <div className='contador'>
                <ItemCount inicial={1} stock={10} onAdd={(cantidad)=>console.log("Cantidad agregada de ",modelo,": ",cantidad)}/> 
            </div>        
        </div>
    )
};
